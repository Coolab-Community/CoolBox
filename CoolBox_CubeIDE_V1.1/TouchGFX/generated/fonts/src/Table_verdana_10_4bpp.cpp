...
KEEP extern const touchgfx::GlyphNode glyphs_verdana_10_4bpp[] FONT_TABLE_LOCATION_FLASH_ATTRIBUTE =
{
    ...
    {    44, 0x0036,   6,   8,   8,   0,   6,   0,   0, 0x00 },
    {    68, 0x0038,   6,   8,   8,   0,   6,   0,   0, 0x00 },
    {    92, 0x003F,   5,   8,   8,   0,   5,   0,   0, 0x00 },
    {   112, 0x0076,   6,   6,   6,   0,   6,   0,   0, 0x00 }
};
...
touchgfx::GeneratedFont& getFont_verdana_10_4bpp()
{
    static touchgfx::GeneratedFont verdana_10_4bpp(glyphs_verdana_10_4bpp, 7, 10, 0, 4, 0, 0, 0, unicodes_verdana_10_4bpp, kerning_verdana_10_4bpp, 63, 0, 0);
